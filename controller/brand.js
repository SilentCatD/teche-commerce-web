...
async function fetchAllBrand(req, res) {
    try {
...
async function fetchBrand(req, res) {
    try {
        const { id } = req.params;
...
async function deleteAllBrand(req, res) {
    try {
...
export { createBrand, fetchAllBrand, fetchBrand, deleteAllBrand, deleteBrand };
